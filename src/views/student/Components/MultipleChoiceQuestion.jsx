...
export default function MultipleChoiceQuestion({ question, saveUserTestScore }) {
  ...
  const handleNextQuestion = () => {
    let isCorrect = false;
    isCorrect =
      questions[currentQuestion].options.find((option) => option.isCorrect).id.toString() === selectedOption;
    if (isCorrect) {
      setScore(score + 1);
      saveUserTestScore();
    }
